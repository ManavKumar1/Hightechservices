    ...
    <nav className="navbar">
      <div className="navbar__container">
        ...
        <ul className={`navbar__menu ${isOpen ? "active" : ""}`}>
          ...
          <li className="navbar__item">
            <Link to="/services" className="navbar__link" onClick={() => setIsOpen(false)}>
              Services
            </Link>
          </li>
          <li className="navbar__item">
            <Link to="/testimonials" className="navbar__link" onClick={() => setIsOpen(false)}>
              Testimonials
            </Link>
          </li>
          <li className="navbar__item">
            <Link to="/contact" className="navbar__link navbar__link--cta" onClick={() => setIsOpen(false)}>
              Contact
            </Link>
          </li>
        </ul>
