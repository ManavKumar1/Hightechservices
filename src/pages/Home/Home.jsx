        ...
        <div className="home__process-container">
          <div className="home__process-header">
            ...
            <p className="home__process-subtitle">
              We follow a simple and efficient process to get your TV back to perfect working condition
            </p>
          </div>
          ...
          <div className="home__process-steps">
            <div className="home__process-step">
              ...
              <div className="home__process-step-content">
                <h3>Diagnosis</h3>
                <p>Our technicians will thoroughly examine your TV to identify the exact issue.</p>
              </div>
            </div>
            ...
            <div className="home__process-step">
              ...
              <div className="home__process-step-content">
                <h3>Quote</h3>
                <p>We provide a transparent quote with no hidden fees before proceeding with repairs.</p>
              </div>
            </div>
            ...
            <div className="home__process-step">
              ...
              <div className="home__process-step-content">
                <h3>Repair</h3>
                <p>Our skilled technicians perform the necessary repairs using quality parts.</p>
              </div>
            </div>
            ...
            <div className="home__process-step">
              ...
              <div className="home__process-step-content">
                <h3>Testing</h3>
                <p>We thoroughly test your TV to ensure everything is working perfectly.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="home__cta-container">
          <div className="home__cta-content">
            ...
            <p className="home__cta-text">
              Don't wait any longer. Contact us today for fast, reliable TV repair services.
            </p>
          ...
          <div className="home__cta-image">
            <img src="/placeholder.svg?height=400&width=500" alt="TV Repair" />
          </div>
        </div>
      </section>
