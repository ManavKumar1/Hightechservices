    ...
    <div className="contact-page">
      <section className="contact-page__hero">
        <div className="contact-page__hero-container">
          ...
          <p className="contact-page__hero-subtitle">Get in touch with our team for all your TV repair needs</p>
        </div>
      </section>
          ...
          <div className="contact-page__info-grid">
            ...
            <div className="contact-page__info-card">
              ...
              <p className="contact-page__info-text">
                ...
                <br />
                support@hightechservices.com
                <br />
                sales@hightechservices.com
              </p>
            </div>
          </div>
        </div>
